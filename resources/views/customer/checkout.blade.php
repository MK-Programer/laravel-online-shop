                        ...
                        <div class="card-body">
                            @foreach (Cart::content() as $item)
                                <div class="d-flex justify-content-between pb-2">
                                    ...
                                    <div class="h6">{{ config('app.currency') . ($item->price * $item->qty) }}</div>
                                </div>
                            @endforeach
                            <div class="d-flex justify-content-between mt-2">
                                <div class="h6"><strong>Subtotal</strong></div>
                                <div class="h6"><strong>{{ config('app.currency') . Cart::subtotal() }}</strong></div>
                            </div>
                            <div class="d-flex justify-content-between summary-end">
                                <div class="h6"><strong>Tax%</strong></div>
                                <div class="h6"><strong>{{ config('cart.tax') . '%' }}</strong></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2">
                            ...
                            <div class="d-flex justify-content-between mt-2 summery-end">
                                ...
                                <div class="h5"><strong>{{ config('app.currency') . (Cart::total() + config('app.shipping_amount')) }}</strong></div>
                            </div>
                        </div>
                    </div>
