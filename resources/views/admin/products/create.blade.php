@extends('admin.layouts.app', ['tab_name' => 'Create Product'])
...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('admin.products.store') }}" method="post" id="product_form" name="product_form">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card mb-3">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="10" class="summernote"
                                                placeholder="Shipping and Returns"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    <script>
        submitFormUsingAjax('product_form');
